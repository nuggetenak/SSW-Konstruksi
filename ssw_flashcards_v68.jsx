...
// ─── DATA: 1345 KARTU (v68: +3 Wayground sets (120qs) + 29 vocab | ID max=1392) ──
const CARDS = [
  // SALAM
  ...
  { id: 1299, category: "alat", source: "lifeline4", furi: "すいへいき", jp: "水平器", romaji: "suihei ki", id_text: "Waterpass / spirit level", desc: "Alat pengukur kerataan/kelurusan horizontal. Digunakan saat memasang pipa dan peralatan." },
  ...
  { id: 1303, category: "alat", source: "lifeline4", furi: "きゃたつ", jp: "脚立", romaji: "kyatatsu", id_text: "Tangga lipat (stepladder)", desc: "Tangga yang bisa berdiri sendiri, dilipat saat tidak digunakan. Untuk pekerjaan di ketinggian sedang." },
  { id: 1304, category: "alat", source: "lifeline4", furi: "はしご", jp: "梯子", romaji: "hashigo", id_text: "Tangga (ladder)", desc: "Tangga panjang yang disandarkan ke dinding. Untuk akses ke tempat tinggi." },
  { id: 1305, category: "alat", source: "lifeline4", furi: "ぱいぷれんち", jp: "パイプレンチ", romaji: "paipu renchi", id_text: "Kunci pipa (pipe wrench)", desc: "Kunci khusus bergigi untuk memutar dan mengencangkan pipa besi/baja." },
  { id: 1306, category: "alat", source: "lifeline4", furi: "もんきーれんち", jp: "モンキーレンチ", romaji: "monkii renchi", id_text: "Kunci inggris (adjustable wrench)", desc: "Kunci yang bisa disesuaikan bukaannya untuk berbagai ukuran baut dan mur." },
  ...
  { id: 1310, category: "alat", source: "lifeline4", furi: "ほーす", jp: "ホース", romaji: "hoosu", id_text: "Selang (hose)", desc: "Pipa fleksibel untuk mengalirkan air atau fluida. Terbuat dari karet atau PVC." },
  ...
  { id: 1332, category: "alat", source: "lifeline4", furi: "けがき", jp: "ケガキ", romaji: "kegaki", id_text: "Kegaki (marking layout lines)", desc: "Teknik menggaris pada permukaan logam untuk panduan pemotongan/penekukan. Alat: スクライバー." },
  ...
  { id: 1336, category: "alat", source: "lifeline4", furi: "わっしゃー", jp: "ワッシャー", romaji: "wasshaa", id_text: "Ring / washer", desc: "Cincin logam tipis yang dipasang di bawah mur/baut untuk mendistribusikan tekanan." },
  { id: 1337, category: "alat", source: "lifeline4", furi: "なっと", jp: "ナット", romaji: "natto", id_text: "Mur (nut)", desc: "Komponen baut berkepala segi enam dengan ulir dalam. Dipasangkan dengan ボルト." },
  ...
  { id: 1342, category: "alat", source: "lifeline4", furi: "かばー", jp: "カバー", romaji: "kabaa", id_text: "Cover / penutup", desc: "Penutup pelindung untuk pipa, kabel, atau peralatan. Contoh: cable cover, duct cover." },
  ...
  { id: 1352, category: "alat", source: "lifeline4", furi: "ばりとり", jp: "バリ取り", romaji: "bari tori", id_text: "Deburring / hilangkan gerinda", desc: "Proses menghilangkan sisa potongan tajam (gerinda) pada logam setelah dipotong." },
  { id: 1353, category: "alat", source: "lifeline4", furi: "めんをとる", jp: "面を取る", romaji: "men wo toru", id_text: "Chamfering / buat chamfer", desc: "Proses menghaluskan tepi tajam pipa/logam dengan sudut 45°." },
  ...
  // ── LIFELINE 5-6 NEW VOCAB (v68: +29 cards, IDs 1364-1392, source: lifeline5-6) ──
  { id: 1364, category: "listrik", source: "lifeline5-6", jp: "手工具", romaji: "tekoogu", furi: "てこうぐ", id_text: "Perkakas tangan (hand tools)", desc: "Alat kerja yang dioperasikan dengan tangan tanpa motor/listrik. Contoh: obeng, palu, tang." },
  { id: 1365, category: "listrik", source: "lifeline5-6", jp: "3路スイッチ", romaji: "sanro suicchi", furi: "さんろスイッチ", id_text: "Saklar dua arah (two-way switch)", desc: "Saklar yang bisa mengontrol satu lampu dari 2 lokasi berbeda. Sering dipasang di tangga atau koridor panjang." },
  { id: 1366, category: "listrik", source: "lifeline5-6", jp: "4路スイッチ", romaji: "yonro suicchi", furi: "よんろスイッチ", id_text: "Saklar empat arah (four-way switch)", desc: "Saklar tambahan yang dipasang di antara 2 buah 3路スイッチ. Memungkinkan kontrol dari 3+ lokasi." },
  { id: 1367, category: "listrik", source: "lifeline5-6", jp: "単極スイッチ", romaji: "tankyoku suicchi", furi: "たんきょくスイッチ", id_text: "Saklar tunggal (single-pole switch)", desc: "Saklar paling sederhana — nyala/mati dari 1 lokasi saja." },
  { id: 1368, category: "listrik", source: "lifeline5-6", jp: "テープ巻き", romaji: "teepu maki", furi: "テープまき", id_text: "Gulungan isolasi (tape winding)", desc: "Proses membalut sambungan kabel dengan selotip isolasi." },
  { id: 1369, category: "listrik", source: "lifeline5-6", jp: "保護テープ", romaji: "hogo teepu", furi: "ほごテープ", id_text: "Pita pelindung (protective tape)", desc: "Pita untuk melindungi kabel/pipa dari gesekan atau kerusakan fisik. Berbeda dari 絶縁テープ." },
  { id: 1370, category: "listrik", source: "lifeline5-6", jp: "結束バンド", romaji: "kessoku bando", furi: "けっそくバンド", id_text: "Cable tie / pengikat kabel", desc: "Tali plastik untuk mengikat dan merapikan kumpulan kabel listrik." },
  { id: 1371, category: "listrik", source: "lifeline5-6", jp: "支線", romaji: "shisen", furi: "しせん", id_text: "Jalur percabangan (branch line)", desc: "Kabel cabang yang menyalurkan listrik dari 幹線 ke peralatan individual." },
  { id: 1372, category: "listrik", source: "lifeline5-6", jp: "吸気ファン", romaji: "kyuuki fan", furi: "きゅうきファン", id_text: "Kipas isap (intake fan)", desc: "Kipas yang menghisap udara dari luar ke dalam ruangan. Berbeda dari 排気ファン (exhaust fan)." },
  { id: 1373, category: "listrik", source: "lifeline5-6", jp: "防振ゴム", romaji: "boushin gomu", furi: "ぼうしんゴム", id_text: "Karet anti-getar (vibration damper)", desc: "Karet yang dipasang di bawah mesin AC/kompresor untuk menyerap getaran." },
  { id: 1374, category: "listrik", source: "lifeline5-6", jp: "吸音材", romaji: "kyuuon zai", furi: "きゅうおんざい", id_text: "Material penyerap suara", desc: "Bahan yang menyerap gelombang suara untuk mengurangi kebisingan di dalam ruangan." },
  { id: 1375, category: "listrik", source: "lifeline5-6", jp: "空気清浄機", romaji: "kuuki seijouki", furi: "くうきせいじょうき", id_text: "Pembersih udara (air purifier)", desc: "Alat untuk memurnikan udara di ruangan dengan menyaring debu & partikel." },
  { id: 1376, category: "listrik", source: "lifeline5-6", jp: "作業灯", romaji: "sagyoutou", furi: "さぎょうとう", id_text: "Lampu kerja (work light)", desc: "Lampu portabel untuk menerangi area kerja gelap di lokasi konstruksi." },
  { id: 1377, category: "pipa", source: "lifeline5-6", jp: "送水ポンプ", romaji: "sousui ponpu", furi: "そうすいポンプ", id_text: "Pompa air bersih (water supply pump)", desc: "Pompa untuk mengalirkan air bersih ke sistem distribusi gedung." },
  { id: 1378, category: "pipa", source: "lifeline5-6", jp: "排水ポンプ", romaji: "haisui ponpu", furi: "はいすいポンプ", id_text: "Pompa air limbah (drainage pump)", desc: "Pompa untuk mengalirkan air limbah/kotor dari gedung ke saluran pembuangan." },
  { id: 1379, category: "pipa", source: "lifeline5-6", jp: "冷却ポンプ", romaji: "reikyaku ponpu", furi: "れいきゃくポンプ", id_text: "Pompa pendingin (cooling pump)", desc: "Pompa untuk mengalirkan air pendingin di sistem AC sentral." },
  { id: 1380, category: "pipa", source: "lifeline5-6", jp: "温水循環ポンプ", romaji: "onsui junkan ponpu", furi: "おんすいじゅんかんポンプ", id_text: "Pompa sirkulasi air panas", desc: "Pompa untuk mensirkulasikan air panas di sistem pemanas gedung." },
  { id: 1381, category: "pipa", source: "lifeline5-6", jp: "ポリブテン管", romaji: "poributen kan", furi: "ポリブテンかん", id_text: "Pipa polibuten (polybutene pipe)", desc: "Pipa plastik fleksibel, tahan korosi, dipakai untuk suplai air panas & dingin." },
  { id: 1382, category: "pipa", source: "lifeline5-6", jp: "鉛管", romaji: "namarikan", furi: "なまりかん", id_text: "Pipa timah (lead pipe)", desc: "Pipa dari timah, dulu dipakai untuk suplai air. Sekarang jarang dipakai karena bahaya kesehatan." },
  { id: 1383, category: "pipa", source: "lifeline5-6", jp: "給水タンク", romaji: "kyuusui tanku", furi: "きゅうすいたんく", id_text: "Tangki air bersih (water supply tank)", desc: "Tangki penampung air bersih di gedung, biasanya di atap atau ruang bawah tanah." },
  { id: 1384, category: "pipa", source: "lifeline5-6", jp: "パイプバンド", romaji: "paipu bando", furi: "パイプバンド", id_text: "Pipe band / pengikat pipa", desc: "Pengikat logam untuk memfiksasi pipa ke dinding atau langit-langit." },
  { id: 1385, category: "alat_umum", source: "lifeline5-6", jp: "モップ", romaji: "moppu", furi: "モップ", id_text: "Mop / alat pel", desc: "Alat pembersih lantai, digunakan untuk membersihkan lokasi kerja." },
  { id: 1386, category: "alat_umum", source: "lifeline5-6", jp: "たらい", romaji: "tarai", furi: "たらい", id_text: "Baskom (basin)", desc: "Wadah besar untuk mencuci atau menampung air." },
  { id: 1387, category: "alat_umum", source: "lifeline5-6", jp: "梯子脚立", romaji: "hashigo kyatatsu", furi: "はしごきゃたつ", id_text: "Tangga lipat (folding ladder)", desc: "Tangga yang bisa dilipat, digunakan untuk pekerjaan di ketinggian rendah." },
  { id: 1388, category: "alat_umum", source: "lifeline5-6", jp: "ゴムパッド", romaji: "gomu paddo", furi: "ゴムパッド", id_text: "Bantalan karet (rubber pad)", desc: "Bantalan karet untuk peredam atau alas anti-selip pada peralatan." },
  { id: 1389, category: "alat_umum", source: "lifeline5-6", jp: "シートガスケット", romaji: "shiito gasuketto", furi: "シートガスケット", id_text: "Gasket lembaran (sheet gasket)", desc: "Gasket berbentuk lembaran untuk mencegah kebocoran pada sambungan flensa." },
  { id: 1390, category: "alat_umum", source: "lifeline5-6", jp: "緩衝材", romaji: "kanshouzai", furi: "かんしょうざい", id_text: "Material peredam benturan (cushioning material)", desc: "Bahan untuk melindungi peralatan atau pipa dari benturan fisik." },
  { id: 1391, category: "alat_umum", source: "lifeline5-6", jp: "段差台", romaji: "dansadai", furi: "だんさだい", id_text: "Platform bertingkat (step platform)", desc: "Platform kecil bertingkat sebagai pijakan untuk pekerjaan di ketinggian rendah." },
  { id: 1392, category: "telekomunikasi", source: "lifeline5-6", jp: "光ケーブル地中配線", romaji: "hikari keepuru chichuu haisen", furi: "ひかりケーブルちちゅうはいせん", id_text: "Pengabelan kabel optik bawah tanah", desc: "Pemasangan kabel serat optik di dalam tanah melalui 管路 atau 共同溝." },
...
const JAC_OFFICIAL = [
  ...
  },
  {
    ...
    options: ["ドライバー (Obeng)", "ポンチ (Punch/penanda)", "ファイバカッター (Pemotong serat)", "電工ナイフ (Pisau listrik)"],
  ...
  },
  {
    ...
    hiragana: "しゃしん の どうぐ の なまえ は どれか。",
    id_text: "Apa nama alat dalam foto?",
    options: ["パイプ万力 (Ragum pipa)", "パイプカッター (Pemotong pipa)", "パイプねじ切機 (Mesin ulir pipa)", "パイプレンチ (Kunci pipa)"],
  ...
  },
  {
    ...
    options: ["消火器 (APAR)", "屋内消火栓設備 (Hidran dalam gedung)", "スプリンクラー設備 (Sprinkler)", "屋外消火栓設備 (Hidran luar gedung)"],
    answer: 4, hasPhoto: true,
  ...
  },
  {
    ...
    hiragana: "しゃしん の どうぐ の なまえ は どれか。",
    id_text: "Apa nama alat dalam foto?",
    options: ["墨さし (Kuas tinta)", "チョーク (Kapur)", "墨つぼ (Wadah tinta/chalk line reel)", "レーザー墨出し器 (Laser marker)"],
  ...
  },
  {
    ...
    hiragana: "しゃしん の どうぐ の なまえ は どれか。",
    id_text: "Apa nama alat dalam foto?",
    options: ["三脚 (Tripod)", "気泡管 (Tabung gelembung)", "望遠鏡 (Teleskop)", "レベル (Level/waterpas survei)"],
    answer: 4, hasPhoto: true,
  ...
  },
  {
    ...
    options: ["環境 (Lingkungan)", "品質 (Kualitas)"],
  ...
  },
  {
    ...
    options: ["100A以上 (100A ke atas)", "15A～100A", "15A以下 (15A ke bawah)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["短絡 (Short circuit)", "漏電 (Arus bocor)", "感電 (Sengatan listrik)"],
  ...
  },
  {
    ...
    options: ["通信ケーブル (Kabel komunikasi)", "管路 (Jalur kabel bawah tanah)", "電柱 (Tiang listrik/telepon)", "マンホール (Manhole)"],
    answer: 3, hasPhoto: true,
  ...
  },
  {
    ...
    options: ["保温材 (Bahan isolasi panas)", "保冷材 (Bahan isolasi dingin)", "耐火物 (Bahan tahan api)", "断熱材 (Bahan insulasi)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["墜落・転落 (Jatuh dari ketinggian / bergulir)", "建設機械・クレーンなど災害 (Kecelakaan mesin/crane)", "高温・低温の物との接触 (Kontak benda suhu ekstrem)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["停電 (Pemadaman listrik)", "火傷 (Luka bakar)", "感電 (Sengatan listrik)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["マンホール内での作業 (Di dalam manhole)", "電柱の上での作業 (Di atas tiang listrik)", "建物屋上での作業 (Di atap gedung)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["換気 (Ventilasi)", "排水 (Drainase)", "土留め (Penahan tanah)"],
    answer: 3, hasPhoto: false,
  ...
  // ── SET 2: st_sample2_l.pdf ────────────────────────────────────────────
  {
    ...
    options: ["損失が小さい (Rugi-rugi kecil)", "重い (Berat)", "傷に強い (Tahan goresan)", "伝送容量が小さい (Kapasitas transmisi kecil)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["ファイバーカッター (Pemotong serat)", "OTDR", "光パワーメーター (Pengukur daya optik)", "クランプメーター (Clamp meter)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["コネクタ接続 (Sambungan konektor)", "はんだあげ (Soldering)", "融着接続 (Fusion splicing)", "メカニカルスプライス接続 (Mechanical splice)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["除湿器 (Penyerap kelembapan)", "冷却コイル (Koil pendingin)", "けい酸カルシウム保温材 (Isolasi kalsium silikat)", "加湿器 (Pelembap udara)"],
  ...
  },
  {
    ...
    options: ["グラスウール保温材 (Wol kaca)", "ロックウール保温材 (Wol batu)", "ポリスチレンフォーム保温材 (Busa polistiren)", "けい酸カルシウム保温材 (Kalsium silikat)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    id_text: "Apa nama alat dalam foto?",
    options: ["一輪車 (Gerobak satu roda)", "台車 (Kereta dorong datar)", "そり (Sledge)", "ころ (Roller)"],
    answer: 2, hasPhoto: true,
  ...
  },
  {
    ...
    options: ["ねじ接合 (Sambungan ulir)", "ＥＦ接合 (EF / Electro Fusion)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["差し込み継手工法 (Insert joint method)", "共板フランジ工法 (Common plate flange method)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["穴掘建柱車 (Kendaraan penggali & pendiri tiang)", "手掘り (Penggalian manual)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["管路 (Jalur kabel bawah tanah)", "共同溝 (Terowongan utilitas bersama)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["耐熱断熱煉瓦用モルタル (Mortar khusus bata tahan api)", "樹脂モルタル (Mortar resin)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["新規入場者教育 (Pendidikan pekerja baru lokasi kerja)", "安全パトロール (Patroli keselamatan)", "新入者安全衛生教育 (Pendidikan K3 pekerja baru perusahaan)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["適切な睡眠と食事をとること (Tidur & makan yang cukup)", "お酒を飲んで作業すること (Bekerja sambil minum alkohol)", "前日に徹夜すること (Begadang sehari sebelumnya)"],
    answer: 1, hasPhoto: false,
  ...
  // ── SET tt1: tt_sample.pdf — 学科 Set 1 (29 soal) ─────────────────────────
  {
    ...
    options: ["興味を持たないこと (Tidak peduli)", "チームワーク (Kerja tim / Teamwork)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["あいさつ (Salam)", "体操 (Senam)", "安全確認 (Konfirmasi keselamatan)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["6時間 (6 jam)", "8時間 (8 jam)", "12時間 (12 jam)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["安全が保証される (Yang menjamin keamanan)", "最低限の (Minimum)", "必要以上の (Lebih dari yang diperlukan)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["増加 (Meningkatkan)", "軽減 (Mengurangi / Meringankan)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["安価な水を供給する (Menyuplai air yang terjangkau)", "高価な水を供給する (Menyuplai air yang mahal)", "不浄な水を供給する (Menyuplai air yang kotor)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["ガス事業法 (UU Usaha Gas)", "電気通信事業法 (UU Usaha Telekomunikasi)", "電波法 (UU Gelombang Radio)", "電気事業法 (UU Usaha Kelistrikan)"],
    answer: 4, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["住宅を作る工事 (Membangun rumah)", "道路を作る工事 (Membangun jalan)", "ダムを作る工事 (Membangun bendungan)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["防水装置 (Alat kedap air)", "免振装置 (Alat isolasi seismik)", "空調装置 (Alat AC)"],
    answer: 2, hasPhoto: true,
  ...
  },
  {
    ...
    options: ["ライフライン工事 (Pekerjaan lifeline)", "建築工事 (Pekerjaan bangunan)", "土木工事 (Pekerjaan sipil)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["掘削工事 (Pekerjaan penggalian)", "トンネル工事 (Pekerjaan terowongan)", "さく井工事 (Pekerjaan pengeboran sumur)", "穴掘工事 (Pekerjaan gali lubang)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["工場で製作した杭を、現場に運んで打ち込む工法 (Tiang dibuat di pabrik, dibawa & dipancang di lapangan)", "工事現場で杭を作る工法 (Tiang dibuat di lokasi proyek)", "既に使用された杭を再利用する工法 (Tiang bekas digunakan kembali)", "穴の中に生コンクリートを入れて杭を造る工法 (Beton segar dituang ke lubang untuk membuat tiang)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["鉄筋工事 (Pekerjaan pembesian)", "型枠工事 (Pekerjaan bekisting)", "鉄筋継手工事 (Pekerjaan sambungan tulangan)", "鉄骨工事 (Pekerjaan struktur baja)"],
    answer: 4, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["鉄筋工事 (Pembesian)", "鉄筋継手工事 (Sambungan tulangan)", "型枠工事 (Bekisting/formwork)", "窓枠工事 (Pemasangan kusen jendela)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["コンクリート打設工事 (Pengecoran beton)", "機械土工事 (Pekerjaan tanah mekanis)", "サッシ工事 (Pemasangan kusen aluminium)", "屋根工事 (Pekerjaan atap)"],
  ...
  },
  {
    ...
    options: ["電気工事士 (Teknisi pekerjaan listrik)", "工事担任者 (Penanggung jawab pekerjaan telekomunikasi)", "電気通信主任技術者 (Insinyur kepala telekomunikasi)", "消防設備士 (Teknisi peralatan pemadam)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["洗面器 (Wastafel)", "焼却炉 (Incinerator/tungku pembakaran)", "スプリンクラー (Sprinkler)", "エアコン (AC)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["作る (Membuat)", "直す (Memperbaiki)", "組み立てる (Merakit)", "壊す (Menghancurkan/membongkar)"],
    answer: 4, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["免許 (Lisensi/izin resmi)", "パスポート (Paspor)", "在留カード (Kartu izin tinggal)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["海外 (Di luar negeri)", "社内 (Di dalam perusahaan)", "労働局 (Di kantor tenaga kerja)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["お大事に (Jaga kesehatan ya)", "ご安全に (Semoga selamat)", "ご注意を (Harap berhati-hati)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["立て墨 (Garis vertikal)", "逃げ墨 (Garis referensi offset)", "仕上げ墨 (Garis finishing)", "地墨 (Garis lantai)"],
    answer: 4, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["根切り (Penggalian fondasi)", "盛り土 (Urugan/timbunan tanah)", "埋戻し (Pengurugan kembali)", "素掘り (Galian mentah tanpa perkuatan)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["あき (Jarak bebas antar tulangan)", "あそび (Kelonggaran)", "かぶり厚さ (Selimut beton / concrete cover)", "間隔 (Jarak/spasi)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["空調 (AC / pengkondisian udara)", "換気 (Ventilasi)", "排煙 (Pembuangan asap)", "衛生 (Sanitasi)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["修理 (Perbaikan)", "相談 (Konsultasi)", "しつけ (Disiplin/Shitsuke)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["喫煙は、まわりから見えない場所で隠れてする (Merokok di tempat tersembunyi dari pandangan orang)", "ごみが落ちているのを見つけたら、そのままにしておく (Biarkan sampah yang ditemukan)", "ヘルメットや安全帯は決められた場所に置く (Simpan helm & harness di tempat yang ditentukan)"],
    answer: 3, hasPhoto: false,
  ...
  // ── SET tt2: tt_sample2.pdf — 学科 Set 2 (36 soal) ────────────────────────
  {
    ...
    options: ["朝礼 (Apel pagi)", "ラジオ体操 (Senam radio)", "安全唱和 (Nyanyian keselamatan)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["KY活動 (Kegiatan KY/identifikasi bahaya)", "タッチアンドコール (Touch-and-call)", "ラジオ体操 (Senam radio)"],
    answer: 2, hasPhoto: true,
  ...
  },
  {
    ...
    options: ["事業主 (Pengusaha/pemberi kerja)", "労働者 (Pekerja/karyawan)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["雇用保険法 (UU Asuransi Ketenagakerjaan)", "労働安全衛生法 (UU Keselamatan & Kesehatan Kerja)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["建設業を営む者の資質の向上 (Peningkatan KUALITAS SDM pelaku konstruksi)", "建設業を営む者の技能の向上 (Peningkatan KETERAMPILAN pelaku konstruksi)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["大気汚染物質 (Polutan udara)", "廃材 (Material sisa/limbah konstruksi)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["都市 (Gas kota/city gas)", "LP (Gas LPG)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["電気工事士 (Teknisi pekerjaan listrik)", "工事担任者 (Penanggung jawab pekerjaan telekomunikasi)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["火災や感電 (Kebakaran dan sengatan listrik)", "ガス漏れ (Kebocoran gas)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["治水 (Pengendalian banjir)", "汚水 (Air kotor/limbah)", "排水 (Drainase/pembuangan air)", "治山 (Konservasi lahan pegunungan)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["海路 (Jalur laut)", "鉄道 (Jalur kereta api)", "空路 (Jalur udara)", "橋 (Jembatan)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["仮設 (Instalasi sementara)", "排水 (Drainase)", "山留め (Penahan tanah galian)", "試掘 (Galian uji coba)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["内装仕上げ (Finishing interior)", "建具 (Kusen pintu/jendela)", "屋根 (Atap)", "躯体 (Struktur utama/kutai)"],
    answer: 4, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["ケーブル工事 (Pekerjaan kabel)", "管路の工事 (Pekerjaan jalur pipa)", "配電盤の工事 (Pekerjaan panel distribusi listrik)", "電柱工事 (Pekerjaan tiang listrik)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["電気通信工事 (Pekerjaan telekomunikasi)", "上水道工事 (Pekerjaan air bersih)", "下水道工事 (Pekerjaan saluran air limbah)", "電気工事 (Pekerjaan listrik)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["ジャッキ (Dongkrak hidrolik/jack)", "クレーン (Crane)", "押輪 (Cincin pendorong)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["マネジメント講習 (Pelatihan manajemen)", "技能講習 (Pelatihan keterampilan)", "基幹技能者講習 (Pelatihan teknisi inti)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["積み込み作業 (Pekerjaan pemuatan/loading)", "盛り土作業 (Pekerjaan urugan tanah)", "敷き均し作業 (Pekerjaan penghamparan/grading)"],
    answer: 3, hasPhoto: true,
  ...
  },
  {
    ...
    options: ["押土 (Mendorong tanah)", "運搬 (Pengangkutan)", "掘削 (Penggalian)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["カーテン工事 (Pemasangan tirai/curtain)", "漆喰補修工事 (Perbaikan plester mortar)", "吹付けウレタン断熱工事 (Semprot insulasi uretan)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["打設 (Pengecoran)", "保温 (Isolasi termal)", "支保工 (Perancah penyangga/shoring)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["機械式継手 (Sambungan mekanis/coupler)", "重ね継手 (Sambungan tumpang)", "溶接継手 (Sambungan las)"],
    answer: 1, hasPhoto: true,
  ...
  },
  {
    ...
    options: ["溶接継手 (Las listrik)", "ガス圧接継手 (Gas pressure welding)", "重ね継手 (Tumpang)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["配線工事 (Pekerjaan pengkabelan)", "接地工事 (Pekerjaan pentanahan)", "内線工事 (Pekerjaan instalasi dalam gedung)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["無線方式 (Sistem nirkabel)", "光ファイバー (Serat optik)", "インターネット (Internet)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["エアコン (AC)", "トイレの便器 (Closet/toilet)", "貯湯槽 (Tangki air panas)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["消火設備 (Peralatan pemadam kebakaran)", "避難設備 (Peralatan evakuasi)", "警報設備 (Peralatan alarm/peringatan)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["危ない (Bahaya! / Awas!)", "足元よし (Kondisi kaki/pijakan aman)", "ご安全に (Semoga selamat)", "起立 (Berdiri)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["水盛り (Penyamaan ketinggian dengan air)", "遣り方 (Setting-out/tata letak referensi)", "水貫 (Papan horizontal referensi)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["路床 (Subgrade/lapisan sub-dasar jalan)", "締固め (Pemadatan)", "段切り (Potongan bertangga/step cutting)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["坪 (Tsubo — satuan luas tradisional)", "寸 (Sun — satuan panjang)", "尺 (Shaku — satuan panjang)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["打ち込み (Pemakuan/menancapkan paku)", "釘仕舞 (Mencabut dan menyimpan paku)", "釘止め (Pengikatan dengan paku)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["接続 (Penyambungan)", "配線 (Pengkabelan)", "絶縁 (Isolasi)"],
    answer: 3, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["接地 (Pentanahan/grounding)", "漏電 (Kebocoran arus)", "通線 (Penarikan kabel)"],
    answer: 1, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["掃除 (Membersihkan)", "整頓 (Menata/merapikan — Seiton)", "清潔 (Bersih/higienis — Seiketsu)"],
    answer: 2, hasPhoto: false,
  ...
  },
  {
    ...
    options: ["上着のボタンは外したままにする (Biarkan kancing jaket terbuka)", "暑い時は半袖を着用する (Saat panas, pakai baju lengan pendek)", "袖は手首までおろして着用する (Turunkan lengan baju hingga pergelangan tangan)"],
    answer: 3, hasPhoto: false,
...
function generateQuiz(targetCards, allCards) {
  return shuffle(targetCards).map(card => {
    ...
    const options = shuffle([
      { text: card.id_text, correct: true },
      ...distractors.map(c => ({ text: c.id_text, correct: false }))
    ]);
    return { card, options };
  });
}
...
function FlashcardMode({ cards, known, setKnown, unknown, setUnknown, starred = new Set(), toggleStar = () => {} }) {
  ...
  const displayCards = search.trim() ? baseCards.filter(c =>
    c.jp.includes(search) || (c.furi || "").includes(search.toLowerCase()) ||
    ...
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 8, padding: "0 16px 10px", maxWidth: 560, margin: "0 auto" }}>
        {[
          ...
          <div key={s.label} style={{ textAlign: "center", background: s.bg, borderRadius: 12, padding: "10px 4px", border: `1px solid ${s.col}18` }}>
            <div style={{ fontSize: 20, fontWeight: 800, color: s.col, lineHeight: 1, letterSpacing: -0.5 }}>{s.val}</div>
            <div style={{ fontSize: 11, color: s.col, opacity: 0.65, marginTop: 3, letterSpacing: 0.5 }}>{s.label}</div>
          </div>
        ))}
      </div>
      ...
      <div style={{ padding: "0 16px 10px", maxWidth: 560, margin: "0 auto" }}>
        <div
          ...
          style={{
            ...
            cursor: "pointer", padding: "44px 22px 20px",
          ...
          {(known.has(card.id) || unknown.has(card.id)) && (
            <div style={{ position: "absolute", top: 13, right: 14, fontSize: 14 }}>
              {known.has(card.id) ? "✅" : "🔴"}
            </div>
          )}

          {/* card id */}
          <div style={{ position: "absolute", bottom: 10, right: 13, fontSize: 10, color: "#334155" }}>#{card.id}</div>

          {!flipped ? (
            <div style={{ textAlign: "center", width: "100%" }}>
              <JpFront text={card.jp} />
              <div style={{ fontSize: 12, color: "#64748b", marginTop: 10, letterSpacing: 0.5 }}>{card.romaji}</div>
              <div style={{ fontSize: 10, color: "#475569", marginTop: 16, letterSpacing: 0.3 }}>tap / swipe ↑</div>
            </div>
          ) : (
            <div style={{ textAlign: "center", width: "100%" }}>
              <div style={{ fontSize: 11, color: "rgba(255,255,255,0.45)", marginBottom: 6, letterSpacing: 0.5 }}>{card.romaji}</div>
              <div style={{ fontSize: 20, fontWeight: 700, marginBottom: 10, fontFamily: "'Noto Sans JP', sans-serif", lineHeight: 1.45, color: "#f1f5f9" }}>{card.id_text}</div>
              {showDesc ? (
                <div style={{ background: "rgba(0,0,0,0.22)", borderRadius: 12, padding: "12px 14px", marginTop: 4 }}>
                  <DescBlock text={card.desc} />
                </div>
              ) : (
                <button onClick={(e) => { e.stopPropagation(); setShowDesc(true); }} style={{ fontFamily: "inherit",
                  marginTop: 4, padding: "8px 18px", fontSize: 12, background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: 20, color: "rgba(255,255,255,0.8)", cursor: "pointer",
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 8, padding: "0 16px 20px", maxWidth: 560, margin: "0 auto" }}>
        {[
          ...
          { icon: "🔁", label: `Salah (${unknownCards.length})`, action: () => { if (unknownCards.length > 0) { setCardOrder(unknownCards.map(c => cards.indexOf(c))); setCurrentIndex(0); setFlipped(false); setShowDesc(false); } }, accent: unknownCards.length > 0, disabled: unknownCards.length === 0 },
        ].map(b => (
          <button key={b.label} onClick={b.action} style={{ fontFamily: "inherit",
            padding: "10px 4px", fontSize: 11, borderRadius: 12,
  ...
  return (
    <div style={{ padding: "0 16px 24px", maxWidth: 560, margin: "0 auto" }}>
      ...
      <div style={{ background: `linear-gradient(135deg,${catInfo.color}bb,${catInfo.color}55)`, borderRadius: 20, padding: "22px 18px", border: `1.5px solid ${catInfo.color}88`, boxShadow: `0 6px 24px ${catInfo.color}22`, marginBottom: 14, textAlign: "center", minHeight: 120, display: "flex", flexDirection: "column", justifyContent: "center" }}>
        ...
        <div style={{ fontSize: 11, color: "rgba(255,255,255,0.35)", marginTop: 10 }}>{q.card.romaji}</div>
      </div>
      {/* OPTIONS */}
      <div style={{ display: "flex", flexDirection: "column", gap: 9, marginBottom: 12 }}>
        {q.options.map((opt, idx) => {
          ...
          return (
            <button key={idx} onClick={() => handleSelect(idx)} style={{ padding: "13px 14px", fontSize: 13, borderRadius: 14, background: bg, border, color, cursor: selected !== null ? "default" : "pointer", textAlign: "left", lineHeight: 1.5, display: "flex", gap: 10, alignItems: "center", fontFamily: "'Noto Sans JP',sans-serif", transition: "all 0.15s" }}>
              <span style={{ width: 26, height: 26, borderRadius: 7, flexShrink: 0, background: "rgba(255,255,255,0.05)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 700, border: "1px solid rgba(255,255,255,0.09)", color: selected !== null ? (opt.correct ? "#4ade80" : idx === selected ? "#f87171" : "rgba(255,255,255,0.15)") : "#64748b" }}>
...
function JACMode() {
  ...
  const [showHiragana, setShowHiragana] = useState(true);    // P3
  const [showID, setShowID] = useState(true);                 // toggle terjemahan Indonesia
    ...
    return (
      <div style={{ padding: "16px", maxWidth: 560, margin: "0 auto" }}>
        <div style={{ background: "rgba(255,255,255,0.06)", borderRadius: 24, padding: "28px 20px", textAlign: "center", border: "1px solid rgba(255,255,255,0.12)" }}>
          ...
          <div style={{ background: "rgba(255,255,255,0.08)", borderRadius: 99, height: 6, overflow: "hidden", marginBottom: 20 }}>
  ...
  return (
    <div style={{ padding: "0 16px 24px", maxWidth: 560, margin: "0 auto" }}>
      ...
      <div style={{ background: "linear-gradient(135deg, rgba(102,126,234,0.25), rgba(118,75,162,0.2))", borderRadius: 20, padding: "16px 20px", border: "2px solid rgba(102,126,234,0.4)", marginBottom: 14 }}>
        {/* Header: set label + toggle buttons */}
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
          ...
          <div style={{ display: "flex", gap: 5 }}>
            <button onClick={() => setShowHiragana(s => !s)} style={{ fontFamily: "inherit",
              padding: "5px 9px", fontSize: 11, borderRadius: 7, cursor: "pointer",
              background: showHiragana ? "rgba(102,126,234,0.4)" : "rgba(255,255,255,0.06)",
              border: "1px solid rgba(102,126,234,0.4)", color: showHiragana ? "#c3dafe" : "#4a5568",
            }}>あ</button>
            <button onClick={() => setShowID(s => !s)} style={{ fontFamily: "inherit",
              padding: "5px 9px", fontSize: 11, borderRadius: 7, cursor: "pointer",
              background: showID ? "rgba(34,197,94,0.2)" : "rgba(255,255,255,0.06)",
              border: "1px solid rgba(34,197,94,0.25)", color: showID ? "#4ade80" : "#4a5568",
            }}>ID</button>
          </div>
        </div>
        {q.hasPhoto && (
        ...
        {q.hiragana && showHiragana && (
          <div style={{ fontSize: 12, lineHeight: 1.65, fontFamily: "'Noto Sans JP', sans-serif", color: "#93c5fd", opacity: 0.75, borderTop: "1px solid rgba(255,255,255,0.07)", paddingTop: 8 }}>
            {q.hiragana}
          </div>
        )}
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 14 }}>
        {shuffledOptions.map((opt, idx) => {
          ...
          const displayText = showID ? opt.text : opt.text.replace(/\s*[\(（][^\)）]*[\)）]/g, "").trim();
          ...
          return (
            <button key={idx} onClick={() => handleSelect(idx)} style={{ padding: "13px 14px", fontSize: 13, borderRadius: 14, background: bg, border, color, cursor: selected !== null ? "default" : "pointer", textAlign: "left", lineHeight: 1.5, display: "flex", gap: 10, alignItems: "center", fontFamily: "'Noto Sans JP', sans-serif", transition: "all 0.15s" }}>
              <span style={{ width: 26, height: 26, borderRadius: 7, flexShrink: 0, background: "rgba(255,255,255,0.06)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 700, border: "1px solid rgba(255,255,255,0.1)" }}>
...
// ─── DATA: DANGER PAIRS ───────────────────────────────────────────────────────
const DANGER_PAIRS = [
  { term: "短絡 (たんらく)", correct: "2 kabel+ bersentuhan TANPA melalui beban → bisa kebakaran", traps: ["arus listrik bocor ke tanah (漏電)", "listrik mengalir ke tubuh manusia (感電)"] },
  { term: "労災保険", correct: "Premi SELURUHNYA ditanggung pengusaha (kecelakaan kerja)", traps: ["premi bersama pengusaha & pekerja", "premi ditanggung pekerja"] },
  { term: "雇用保険", correct: "Premi BERSAMA pengusaha & pekerja — tunjangan pengangguran", traps: ["premi seluruhnya pengusaha", "premi seluruhnya pekerja"] },
  { term: "ご苦労様 (ごくろうさま)", correct: "HANYA boleh ke bawahan — JANGAN ke atasan", traps: ["bisa ke siapa saja seperti お疲れ様", "diucapkan ke atasan sebagai rasa hormat"] },
  { term: "グラスウール", correct: "Dari KACA (ガラス) yang dilelehkan menjadi serat", traps: ["dari batu basalt/andesit → itu ロックウール", "dari busa polimer sintetis"] },
  { term: "新規入場者教育", correct: "Untuk PENDATANG BARU ke LOKASI KERJA (bukan rekrutan baru perusahaan)", traps: ["untuk pekerja baru rekrutan perusahaan (新入者安全衛生教育)", "untuk semua pekerja setiap bulan"] },
  { term: "OTDR", correct: "Mengukur PANJANG JALUR & titik abnormal serat optik", traps: ["hanya mengukur kekuatan sinyal → itu 光パワーメーター", "menyambungkan serat optik → itu 融着接続"] },
  { term: "ラッキングカバー", correct: "HANYA untuk pipa terekspos di LUAR RUANGAN (屋外露出)", traps: ["semua pipa termasuk dalam ruangan", "pipa panas suhu tinggi saja"] },
  { term: "電気事業法", correct: "UU mengatur PERUSAHAAN PENYEDIA LISTRIK (utility company)", traps: ["UU mengatur KONTRAKTOR listrik → itu 電気工事業法", "UU mengatur usaha telekomunikasi"] },
  { term: "土留め ≥ 1.5m", correct: "Wajib dipasang jika kedalaman galian ≥ 1.5m", traps: ["wajib jika ≥ 1.0m (terlalu rendah)", "wajib jika ≥ 2.0m (terlalu tinggi)"] },
  { term: "既成杭工法 (きせいぐい)", correct: "Tiang dibuat di PABRIK, kemudian dipancang ke lapangan", traps: ["tiang dibuat langsung di lapangan → itu 場所打ち杭", "tiang bekas yang digunakan ulang"] },
  { term: "さく井工事", correct: "Pekerjaan PENGEBORAN SUMUR air — bukan galian biasa", traps: ["pekerjaan galian tanah umum (掘削工事)", "pekerjaan pengeboran minyak/gas"] },
  { term: "押土 (おしど)", correct: "Mendorong tanah dengan BULLDOZER (ブルドーザ)", traps: ["memadatkan tanah dengan roller → itu 転圧", "mengangkat tanah dengan excavator"] },
  { term: "CD管 vs PF管", correct: "CD管 = khusus dalam BETON (oranye, fleksibel); PF管 = instalasi umum (tidak boleh dalam beton)", traps: ["CD管 boleh di mana saja termasuk luar beton", "keduanya sama saja & bisa dipakai bergantian"] },
  { term: "ライニング管の切断", correct: "Harus pakai バンドソー atau 金属ノコギリ — DILARANG ガス溶断", traps: ["boleh pakai ガス溶断 (acetylene torch)", "boleh pakai グラインダー"] },
  { term: "銅管 (冷媒管) の切断", correct: "Harus pakai パイプカッター saja — DILARANG 金ノコ/グラインダー", traps: ["boleh pakai 金ノコ (gergaji logam)", "boleh pakai グラインダー"] },
  { term: "免振 vs 制振 vs 耐震", correct: "免振 = isolator di fondasi; 制振 = damper dalam bangunan; 耐震 = struktur diperkuat", traps: ["免振 = damper di dinding; 耐震 = isolator fondasi", "ketiganya sama, hanya istilah berbeda"] },
  { term: "治水 vs 利水", correct: "治水 = cegah/kendalikan banjir; 利水 = manfaatkan air (irigasi/PLTA)", traps: ["治水 = memanfaatkan air; 利水 = mencegah banjir (terbalik)", "keduanya sama-sama tujuan bendungan"] },
  { term: "圧着ペンチ 赤 vs 黄", correct: "赤 (merah) = untuk 圧着端子; 黄 (kuning) = untuk リングスリーブ", traps: ["赤 = untuk リングスリーブ; 黄 = untuk 圧着端子 (terbalik)", "warna tidak penting, bisa dipakai bergantian"] },
  { term: "軍手 + ねじ切り機", correct: "DILARANG KERAS memakai sarung tangan kain (軍手) saat pakai mesin ulir", traps: ["dianjurkan memakai 軍手 agar tidak terluka", "wajib memakai sarung tangan apapun saat mesin hidup"] },
];
...
const WAYGROUND_SETS = [
  ...
  // ── wg6: Lifeline Vocab 50qs ──
  {
    ...
    questions: [
    { id: 1, q: "Apa arti dari \"pipa air panas\"?", hint: "温水管 or 給水管?", opts: ["温水管（おんすいかん）", "給水管（きゅうすいかん）", "排水管（はいすいかん）"], opts_id: ["Pipa air panas ✓", "Pipa suplai air", "Pipa pembuangan"], ans: 0, exp: "温水管（おんすいかん）= pipa air panas." },
    { id: 2, q: "Apa arti dari \"katup pengaman\"?", hint: "安全弁 or 止水栓?", opts: ["安全弁（あんぜんべん）", "止水栓（しすいせん）", "開閉弁（かいへいべん）"], opts_id: ["Katup pengaman (safety valve) ✓", "Keran penutup air", "Katup buka-tutup"], ans: 0, exp: "安全弁 = katup pengaman yang melepas tekanan berlebih." },
    { id: 3, q: "Apa arti dari \"saluran pembuangan\"?", hint: "排水路 or 給水口?", opts: ["排水路（はいすいろ）", "給水口（きゅうすいこう）", "換気口（かんきこう）"], opts_id: ["Saluran pembuangan ✓", "Lubang suplai air", "Lubang ventilasi"], ans: 0, exp: "排水路 = saluran pembuangan air." },
    { id: 4, q: "Apa arti dari \"sambungan pipa\"?", hint: "継手 or 弁?", opts: ["継手（つぎて）", "弁（べん）", "管（かん）"], opts_id: ["Fitting / sambungan ✓", "Katup", "Pipa"], ans: 0, exp: "継手（つぎて）= fitting untuk menyambung dua pipa." },
    { id: 5, q: "Apa arti dari \"pipa bawah tanah\"?", hint: "地中管 or 天井管?", opts: ["地中管（ちちゅうかん）", "地上管（ちじょうかん）", "天井管（てんじょうかん）"], opts_id: ["Pipa bawah tanah ✓", "Pipa di atas tanah", "Pipa langit-langit"], ans: 0, exp: "地中管 = pipa yang ditanam di bawah tanah." },
    { id: 6, q: "温水器（おんすいき）とは何ですか？", hint: "Pemanas air or Pipa air panas?", opts: ["Pemanas air", "Pipa air panas", "Katup pembuka"], opts_id: ["Pemanas air (water heater) ✓", "Pipa air panas", "Katup pembuka"], ans: 0, exp: "温水器 = pemanas air / water heater." },
    { id: 7, q: "止水栓（しすいせん）の役割（やくわり）は何ですか？", hint: "Menghentikan aliran air?", opts: ["Menghentikan aliran air", "Meningkatkan tekanan air", "Mengukur suhu air"], opts_id: ["Menghentikan aliran air ✓", "Meningkatkan tekanan", "Mengukur suhu"], ans: 0, exp: "止水栓 = keran penutup air, menghentikan aliran air." },
    { id: 8, q: "配電盤（はいでんばん）の機能（きのう）は何ですか？", hint: "Mengatur distribusi listrik?", opts: ["Mengatur distribusi listrik", "Menyimpan listrik", "Mendinginkan kabel"], opts_id: ["Mengatur distribusi listrik ✓", "Menyimpan listrik", "Mendinginkan kabel"], ans: 0, exp: "配電盤 = panel distribusi listrik, mengatur pembagian arus." },
    { id: 9, q: "保温材（ほおんざい）の目的（もくてき）は何ですか？", hint: "Menahan panas?", opts: ["Menahan panas", "Membuang panas", "Meningkatkan tekanan"], opts_id: ["Menahan panas ✓", "Membuang panas", "Meningkatkan tekanan"], ans: 0, exp: "保温材 = material insulasi untuk menahan panas agar tidak hilang." },
    { id: 10, q: "排水管（はいすいかん）の役割（やくわり）は何ですか？", hint: "Membuang air kotor?", opts: ["Membuang air kotor", "Menyalurkan air bersih", "Menyaring air"], opts_id: ["Membuang air kotor ✓", "Menyalurkan air bersih", "Menyaring air"], ans: 0, exp: "排水管 = pipa pembuangan air kotor/limbah." },
    { id: 11, q: "Apa arti dari \"kabel listrik\"?", hint: "電線 or 電源?", opts: ["電線（でんせん）", "照明（しょうめい）", "電源（でんげん）"], opts_id: ["Kabel listrik ✓", "Lampu penerangan", "Sumber daya"], ans: 0, exp: "電線 = kabel listrik / kawat penghantar arus." },
    { id: 12, q: "Apa arti dari \"saringan\"?", hint: "フィルター or バルブ?", opts: ["フィルター", "バルブ", "ポンプ"], opts_id: ["Filter / saringan ✓", "Katup", "Pompa"], ans: 0, exp: "フィルター = filter / saringan untuk menyaring kotoran." },
    { id: 13, q: "Apa arti dari \"pipa gas\"?", hint: "ガス管?", opts: ["ガス管（がすかん）", "空気管（くうきかん）", "油管（ゆかん）"], opts_id: ["Pipa gas ✓", "Pipa udara", "Pipa minyak"], ans: 0, exp: "ガス管 = pipa untuk menyalurkan gas kota." },
    { id: 14, q: "Apa arti dari \"penutup pipa\"?", hint: "キャップ?", opts: ["キャップ", "コック", "カバー"], opts_id: ["Cap / penutup pipa ✓", "Keran kecil", "Cover umum"], ans: 0, exp: "キャップ = tutup ujung pipa." },
    { id: 15, q: "Apa arti dari \"pengukur tekanan\"?", hint: "圧力計?", opts: ["圧力計（あつりょくけい）", "温度計（おんどけい）", "水平器（すいへいき）"], opts_id: ["Pressure gauge ✓", "Thermometer", "Waterpass"], ans: 0, exp: "圧力計 = alat ukur tekanan / pressure gauge." },
    { id: 16, q: "給湯管（きゅうとうかん）とは何ですか？", hint: "Pipa air panas?", opts: ["Pipa air panas", "Pipa air dingin", "Pipa pembuangan"], opts_id: ["Pipa suplai air panas ✓", "Pipa air dingin", "Pipa pembuangan"], ans: 0, exp: "給湯管 = pipa suplai air panas ke keran/shower." },
    { id: 17, q: "安全弁（あんぜんべん）の役割（やくわり）は何ですか？", hint: "Melepaskan tekanan berlebih?", opts: ["Melepaskan tekanan berlebih", "Memasukkan air bersih", "Menyaring udara"], opts_id: ["Melepas tekanan berlebih ✓", "Memasukkan air bersih", "Menyaring udara"], ans: 0, exp: "安全弁 = katup pengaman, melepas tekanan berlebih untuk cegah ledakan." },
    { id: 18, q: "換気扇（かんきせん）の目的（もくてき）は何ですか？", hint: "Mengeluarkan udara kotor?", opts: ["Mengeluarkan udara kotor", "Mengalirkan air", "Mengukur tekanan"], opts_id: ["Mengeluarkan udara kotor ✓", "Mengalirkan air", "Mengukur tekanan"], ans: 0, exp: "換気扇 = kipas ventilasi untuk membuang udara kotor dari ruangan." },
    { id: 19, q: "排気口（はいきこう）とは何ですか？", hint: "Lubang pembuangan udara?", opts: ["Lubang pembuangan udara", "Saluran air", "Lubang pengukur tekanan"], opts_id: ["Lubang pembuangan udara ✓", "Saluran air", "Lubang tekanan"], ans: 0, exp: "排気口 = lubang tempat udara kotor keluar." },
    { id: 20, q: "Apa arti dari \"pemutus arus\"?", hint: "ブレーカー?", opts: ["ブレーカー", "スイッチ", "コンセント"], opts_id: ["Breaker / pemutus arus ✓", "Saklar", "Stop kontak"], ans: 0, exp: "ブレーカー = pemutus arus otomatis saat arus berlebih." },
    { id: 21, q: "Apa arti dari \"lampu penerangan\"?", hint: "照明?", opts: ["照明（しょうめい）", "電源（でんげん）", "配線（はいせん）"], opts_id: ["Lampu penerangan ✓", "Sumber daya", "Pengabelan"], ans: 0, exp: "照明 = lampu penerangan / lighting." },
    { id: 22, q: "Apa arti dari \"pipa saluran udara\"?", hint: "風管?", opts: ["風管（ふうかん）", "水道管（すいどうかん）", "排水管（はいすいかん）"], opts_id: ["Duct / pipa udara ✓", "Pipa air bersih", "Pipa pembuangan"], ans: 0, exp: "風管 = saluran/duct untuk mengalirkan udara." },
    { id: 23, q: "Apa arti dari \"pompa air\"?", hint: "ポンプ?", opts: ["ポンプ", "バルブ", "ホース"], opts_id: ["Pompa ✓", "Katup", "Selang"], ans: 0, exp: "ポンプ = pompa untuk memindahkan fluida." },
    { id: 24, q: "Apa arti dari \"tangga lipat\"?", hint: "脚立 or 梯子?", opts: ["脚立（きゃたつ）", "梯子（はしご）", "足場（あしば）"], opts_id: ["Tangga lipat (stepladder) ✓", "Tangga sandar", "Scaffolding"], ans: 0, exp: "脚立 = tangga lipat yang bisa berdiri sendiri." },
    { id: 25, q: "断熱材（だんねつざい）とは何ですか？", hint: "Bahan isolasi panas?", opts: ["Bahan isolasi panas", "Pipa air panas", "Penutup pipa"], opts_id: ["Bahan isolasi panas ✓", "Pipa air panas", "Penutup pipa"], ans: 0, exp: "断熱材 = material insulasi termal, mencegah perpindahan panas." },
    { id: 26, q: "冷媒管（れいばいかん）の役割（やくわり）は何ですか？", hint: "Menyalurkan refrigeran?", opts: ["Menyalurkan refrigeran", "Menyalurkan air panas", "Mengalirkan udara"], opts_id: ["Menyalurkan refrigeran ✓", "Menyalurkan air panas", "Mengalirkan udara"], ans: 0, exp: "冷媒管 = pipa untuk mengalirkan refrigeran dalam sistem AC." },
    { id: 27, q: "流量計（りゅうりょうけい）とは何ですか？", hint: "Alat pengukur aliran?", opts: ["Alat pengukur aliran", "Pompa air", "Katup pembuka"], opts_id: ["Alat pengukur aliran (flow meter) ✓", "Pompa air", "Katup pembuka"], ans: 0, exp: "流量計 = flow meter, alat ukur debit aliran fluida." },
    { id: 28, q: "保冷材（ほれいざい）の目的（もくてき）は何ですか？", hint: "Menahan suhu dingin?", opts: ["Menahan suhu dingin", "Memanaskan udara", "Meningkatkan tekanan"], opts_id: ["Menahan suhu dingin ✓", "Memanaskan udara", "Meningkatkan tekanan"], ans: 0, exp: "保冷材 = material insulasi dingin, menjaga suhu rendah dan cegah kondensasi." },
    { id: 29, q: "電動工具（でんどうこうぐ）とは何ですか？", hint: "Alat kerja bertenaga listrik?", opts: ["Alat kerja bertenaga listrik", "Alat manual", "Alat pengukur suhu"], opts_id: ["Power tool / alat listrik ✓", "Alat manual", "Alat ukur suhu"], ans: 0, exp: "電動工具 = power tool / alat kerja yang digerakkan oleh listrik." },
    { id: 30, q: "Apa arti dari \"kunci pipa\"?", hint: "パイプレンチ?", opts: ["パイプレンチ", "モンキーレンチ", "ドライバー"], opts_id: ["Pipe wrench / kunci pipa ✓", "Adjustable wrench", "Obeng"], ans: 0, exp: "パイプレンチ = kunci pipa bergigi untuk memutar pipa besi." },
    { id: 31, q: "Apa arti dari \"pipa pembuangan air hujan\"?", hint: "雨水管?", opts: ["雨水管（うすいかん）", "排気管（はいきかん）", "換気管（かんきかん）"], opts_id: ["Pipa air hujan ✓", "Pipa buang gas", "Pipa ventilasi"], ans: 0, exp: "雨水管 = pipa untuk mengalirkan air hujan dari atap." },
    { id: 32, q: "Apa arti dari \"katup pembuka\"?", hint: "開閉弁?", opts: ["開閉弁（かいへいべん）", "安全弁（あんぜんべん）", "止水栓（しすいせん）"], opts_id: ["Katup buka-tutup ✓", "Katup pengaman", "Keran penutup air"], ans: 0, exp: "開閉弁 = katup untuk membuka dan menutup aliran." },
    { id: 33, q: "Apa arti dari \"pipa air bersih\"?", hint: "給水管?", opts: ["給水管（きゅうすいかん）", "排水管（はいすいかん）", "湯管（ゆかん）"], opts_id: ["Pipa suplai air bersih ✓", "Pipa pembuangan", "Pipa air panas"], ans: 0, exp: "給水管 = pipa suplai air bersih / clean water supply pipe." },
    { id: 34, q: "Apa arti dari \"alat ukur suhu\"?", hint: "温度計?", opts: ["温度計（おんどけい）", "圧力計（あつりょくけい）", "流量計（りゅうりょうけい）"], opts_id: ["Termometer ✓", "Pressure gauge", "Flow meter"], ans: 0, exp: "温度計 = termometer / alat ukur suhu." },
    { id: 35, q: "水道管（すいどうかん）とは何ですか？", hint: "Pipa air bersih?", opts: ["Pipa air bersih", "Pipa pembuangan", "Pipa gas"], opts_id: ["Pipa air bersih ✓", "Pipa pembuangan", "Pipa gas"], ans: 0, exp: "水道管 = pipa air bersih / water supply pipe." },
    { id: 36, q: "バルブとは何ですか？", hint: "Katup?", opts: ["Katup", "Pompa", "Saringan"], opts_id: ["Katup / valve ✓", "Pompa", "Saringan"], ans: 0, exp: "バルブ = katup / valve untuk mengatur aliran fluida." },
    { id: 37, q: "冷却塔（れいきゃくとう）の役割（やくわり）は何ですか？", hint: "Mendinginkan air?", opts: ["Mendinginkan air", "Menyaring udara", "Memanaskan air"], opts_id: ["Mendinginkan air sirkulasi ✓", "Menyaring udara", "Memanaskan air"], ans: 0, exp: "冷却塔 = cooling tower, mendinginkan air sirkulasi sistem AC." },
    { id: 38, q: "換気口（かんきこう）とは何ですか？", hint: "Lubang ventilasi?", opts: ["Lubang ventilasi", "Saluran air", "Lubang pengukur tekanan"], opts_id: ["Lubang ventilasi ✓", "Saluran air", "Lubang tekanan"], ans: 0, exp: "換気口 = lubang ventilasi untuk sirkulasi udara segar." },
    { id: 39, q: "ホースとは何ですか？", hint: "Selang?", opts: ["Selang", "Pompa", "Katup"], opts_id: ["Selang (hose) ✓", "Pompa", "Katup"], ans: 0, exp: "ホース = selang fleksibel untuk air/fluida." },
    { id: 40, q: "Apa arti dari \"selang\"?", hint: "ホース?", opts: ["ホース", "パイプ", "チューブ"], opts_id: ["Hose / selang ✓", "Pipa keras", "Tabung"], ans: 0, exp: "ホース = selang." },
    { id: 41, q: "Apa arti dari \"pemanas air\"?", hint: "温水器?", opts: ["温水器（おんすいき）", "冷却器（れいきゃくき）", "加湿器（かしつき）"], opts_id: ["Water heater ✓", "Cooler", "Humidifier"], ans: 0, exp: "温水器 = pemanas air / water heater." },
    { id: 42, q: "Apa arti dari \"penutup ventilasi\"?", hint: "グリル?", opts: ["グリル", "フィルター", "カバー"], opts_id: ["Grill ventilasi ✓", "Filter", "Cover"], ans: 0, exp: "グリル = penutup berlubang pada saluran ventilasi." },
    { id: 43, q: "Apa arti dari \"pipa udara dingin\"?", hint: "冷風管?", opts: ["冷風管（れいふうかん）", "温風管（おんぷうかん）", "換気管（かんきかん）"], opts_id: ["Cold air duct ✓", "Hot air duct", "Ventilation duct"], ans: 0, exp: "冷風管 = pipa/duct udara dingin dari AC." },
    { id: 44, q: "Apa arti dari \"kabel bawah tanah\"?", hint: "地中ケーブル?", opts: ["地中ケーブル（ちちゅうけーぶる）", "地上ケーブル（ちじょうけーぶる）", "架空ケーブル（かくうけーぶる）"], opts_id: ["Kabel bawah tanah ✓", "Kabel di atas tanah", "Kabel udara"], ans: 0, exp: "地中ケーブル = kabel yang ditanam di bawah tanah." },
    { id: 45, q: "開閉弁（かいへいべん）の機能（きのう）は何ですか？", hint: "Membuka dan menutup aliran?", opts: ["Membuka dan menutup aliran", "Mengukur tekanan", "Menyaring udara"], opts_id: ["Buka-tutup aliran ✓", "Ukur tekanan", "Saring udara"], ans: 0, exp: "開閉弁 = katup untuk membuka dan menutup aliran fluida." },
    { id: 46, q: "雨水管（うすいかん）の役割（やくわり）は何ですか？", hint: "Menyalurkan air hujan?", opts: ["Menyalurkan air hujan", "Mengalirkan udara", "Menahan panas"], opts_id: ["Menyalurkan air hujan ✓", "Mengalirkan udara", "Menahan panas"], ans: 0, exp: "雨水管 = pipa pembuangan air hujan dari atap." },
    { id: 47, q: "配線（はいせん）とは何ですか？", hint: "Instalasi kabel?", opts: ["Instalasi kabel", "Saluran air", "Pipa udara"], opts_id: ["Instalasi kabel / wiring ✓", "Saluran air", "Pipa udara"], ans: 0, exp: "配線 = pengabelan / instalasi kabel listrik." },
    { id: 48, q: "フィルターの役割（やくわり）は何ですか？", hint: "Menyaring kotoran?", opts: ["Menyaring kotoran", "Mengalirkan air", "Mengukur suhu"], opts_id: ["Menyaring kotoran ✓", "Mengalirkan air", "Mengukur suhu"], ans: 0, exp: "フィルター = filter, menyaring kotoran dari udara/air." },
    { id: 49, q: "温風管（おんぷうかん）とは何ですか？", hint: "Pipa udara panas?", opts: ["Pipa udara panas", "Pipa air panas", "Saluran udara dingin"], opts_id: ["Pipa udara panas / hot air duct ✓", "Pipa air panas", "Saluran udara dingin"], ans: 0, exp: "温風管 = duct/saluran udara panas dari pemanas." }
    ]
  },
  // ── wg7: 第6章 Vocab 50qs ──
  {
    ...
    { id: 3, q: "電柱（でんちゅう）の意味は何ですか？", hint: "Tiang listrik?", opts: ["Tiang listrik", "Pipa air", "Menara baja"], opts_id: ["Tiang listrik ✓", "Pipa air", "Menara baja"], ans: 0, exp: "電柱 = tiang listrik di pinggir jalan." },
    { id: 4, q: "変圧器（へんあつき）の意味は何ですか？", hint: "Transformator?", opts: ["Transformator", "Saklar", "Panel"], opts_id: ["Trafo / transformator ✓", "Saklar", "Panel"], ans: 0, exp: "変圧器 = transformator, mengubah tegangan listrik." },
    { id: 5, q: "ハンドホールの意味は何ですか？", hint: "Handhole?", opts: ["Handhole", "Manhole", "Kotak sambungan"], opts_id: ["Handhole (lubang akses kecil) ✓", "Manhole (lebih besar)", "Kotak sambungan"], ans: 0, exp: "ハンドホール = lubang akses kecil untuk kabel bawah tanah." },
    ...
    { id: 9, q: "ナットの意味は何ですか？", hint: "Mur?", opts: ["Mur", "Baut", "Paku"], opts_id: ["Mur (nut) ✓", "Baut", "Paku"], ans: 0, exp: "ナット = mur / nut yang dipasangkan dengan baut." },
    { id: 10, q: "ワッシャーの意味は何ですか？", hint: "Ring?", opts: ["Ring", "Baut", "Konektor"], opts_id: ["Ring / washer ✓", "Baut", "Konektor"], ans: 0, exp: "ワッシャー = ring/washer di bawah mur untuk distribusi tekanan." },
    { id: 11, q: "配管（はいかん）の意味は何ですか？", hint: "Pemipaan?", opts: ["Pemipaan", "Pengeboran", "Pemotongan"], opts_id: ["Pemipaan / piping ✓", "Pengeboran", "Pemotongan"], ans: 0, exp: "配管 = pemipaan / piping system." },
    { id: 12, q: "保温（ほおん）の意味は何ですか？", hint: "Isolasi panas?", opts: ["Isolasi panas", "Isolasi dingin", "Pemanas"], opts_id: ["Isolasi panas ✓", "Isolasi dingin", "Pemanas"], ans: 0, exp: "保温 = insulasi panas / heat insulation." },
    { id: 13, q: "保冷（ほれい）の意味は何ですか？", hint: "Isolasi dingin?", opts: ["Isolasi dingin", "Isolasi panas", "Pendingin"], opts_id: ["Isolasi dingin ✓", "Isolasi panas", "Pendingin"], ans: 0, exp: "保冷 = insulasi dingin / cold insulation." },
    { id: 14, q: "施工（せこう）の意味は何ですか？", hint: "Pelaksanaan konstruksi?", opts: ["Pelaksanaan konstruksi", "Perencanaan konstruksi", "Perbaikan konstruksi"], opts_id: ["Pelaksanaan konstruksi ✓", "Perencanaan", "Perbaikan"], ans: 0, exp: "施工 = pelaksanaan konstruksi / construction execution." },
    { id: 15, q: "工具（こうぐ）の意味は何ですか？", hint: "Peralatan kerja?", opts: ["Peralatan kerja", "Bahan bangunan", "Mesin besar"], opts_id: ["Peralatan kerja / tools ✓", "Bahan bangunan", "Mesin besar"], ans: 0, exp: "工具 = peralatan kerja / tools." },
    ...
    { id: 17, q: "施工要領（せこうようりょう）の意味は何ですか？", hint: "Prosedur kerja?", opts: ["Prosedur kerja", "Pelaksanaan proyek", "Perencanaan konstruksi"], opts_id: ["Prosedur kerja ✓", "Pelaksanaan proyek", "Perencanaan"], ans: 0, exp: "施工要領 = prosedur kerja / work procedure manual." },
    { id: 18, q: "管の据付（かんのすえつけ）の意味は何ですか？", hint: "Pemasangan pipa?", opts: ["Pemasangan pipa", "Pemotongan pipa", "Pembersihan pipa"], opts_id: ["Pemasangan pipa ✓", "Pemotongan", "Pembersihan"], ans: 0, exp: "管の据付 = pemasangan/instalasi pipa di lokasi." },
    { id: 19, q: "コネクタの意味は何ですか？", hint: "Konektor?", opts: ["Konektor", "Pengontrol", "Indikator"], opts_id: ["Konektor ✓", "Pengontrol", "Indikator"], ans: 0, exp: "コネクタ = konektor / penghubung kabel atau pipa." },
    { id: 20, q: "電熱線（でんねつせん）の意味は何ですか？", hint: "Kawat pemanas?", opts: ["Kawat pemanas", "Kabel listrik", "Kabel baja"], opts_id: ["Kawat pemanas ✓", "Kabel listrik", "Kabel baja"], ans: 0, exp: "電熱線 = kawat pemanas / heating wire (untuk cegah pembekuan pipa)." },
    ...
    { id: 22, q: "真円修正（しんえんしゅうせい）の意味は何ですか？", hint: "Koreksi kebulatan?", opts: ["Koreksi kebulatan", "Pemotongan pipa", "Pembersihan pipa"], opts_id: ["Koreksi kebulatan pipa ✓", "Pemotongan", "Pembersihan"], ans: 0, exp: "真円修正 = koreksi bentuk bulat pipa yang oval/penyok." },
    { id: 23, q: "マーキングの意味は何ですか？", hint: "Menandai?", opts: ["Menandai", "Menggambar", "Mengecat"], opts_id: ["Menandai / marking ✓", "Menggambar", "Mengecat"], ans: 0, exp: "マーキング = menandai posisi pemotongan atau pemasangan." },
    { id: 24, q: "ゴム輪のセット（ゴムわのセット）の意味は何ですか？", hint: "Pasang cincin karet?", opts: ["Pasang cincin karet", "Lepas cincin karet", "Bersihkan cincin karet"], opts_id: ["Pasang cincin karet ✓", "Lepas", "Bersihkan"], ans: 0, exp: "ゴム輪のセット = pemasangan cincin karet/o-ring pada pipa." },
  ...
  // ── wg8: 第6章 Vocab 50qs (2) ──
  {
    ...
    { id: 4, q: "滑剤の塗布（かつざいのとふ）の意味は何ですか？", hint: "Pengolesan pelumas?", opts: ["Pengolesan pelumas", "Pembersihan pipa", "Pemotongan pipa"], opts_id: ["Pengolesan pelumas ✓", "Pembersihan", "Pemotongan"], ans: 0, exp: "滑剤の塗布 = mengoles pelumas pada sambungan pipa agar mudah dimasukkan." },
    { id: 5, q: "挿し口の挿入（さしくちのそうにゅう）の意味は何ですか？", hint: "Masukkan spigot?", opts: ["Masukkan spigot", "Masukkan pipa", "Masukkan kabel"], opts_id: ["Masukkan spigot ke socket ✓", "Masukkan pipa", "Masukkan kabel"], ans: 0, exp: "挿し口の挿入 = memasukkan ujung spigot pipa ke socket." },
    { id: 6, q: "曲げ配管（まげはいかん）の意味は何ですか？", hint: "Pemipaan tekukan?", opts: ["Pemipaan tekukan", "Pemipaan lurus", "Pemipaan bawah tanah"], opts_id: ["Pemipaan tekukan / bent piping ✓", "Pemipaan lurus", "Pemipaan bawah tanah"], ans: 0, exp: "曲げ配管 = pemipaan yang ditekuk / bent piping." },
    ...
    { id: 8, q: "EFソケットの意味は何ですか？", hint: "Soket EF?", opts: ["Soket EF", "Konektor EF", "Pipa EF"], opts_id: ["Soket electrofusion ✓", "Konektor EF", "Pipa EF"], ans: 0, exp: "EFソケット = soket electrofusion dengan kawat pemanas internal." },
    { id: 9, q: "融着準備（ゆうちゃくじゅんび）の意味は何ですか？", hint: "Persiapan fusi?", opts: ["Persiapan fusi", "Pembersihan permukaan fusi", "Pengolesan pelumas"], opts_id: ["Persiapan fusi ✓", "Bersihkan permukaan fusi", "Oles pelumas"], ans: 0, exp: "融着準備 = langkah-langkah persiapan sebelum electrofusion welding." },
    { id: 10, q: "融着面の清掃（ゆうちゃくめんのせいそう）の意味は何ですか？", hint: "Bersihkan permukaan fusi?", opts: ["Bersihkan permukaan fusi", "Bersihkan pipa", "Bersihkan insulasi"], opts_id: ["Bersihkan area yang akan difusi ✓", "Bersihkan pipa umum", "Bersihkan insulasi"], ans: 0, exp: "融着面の清掃 = membersihkan permukaan yang akan difusi dari kotoran." },
    ...
    { id: 15, q: "災害（さいがい）の意味は何ですか？", hint: "Bencana?", opts: ["Bencana", "Kecelakaan", "Peristiwa"], opts_id: ["Bencana / disaster ✓", "Kecelakaan", "Peristiwa"], ans: 0, exp: "災害 = bencana / disaster (gempa, banjir, dll)." },
    { id: 16, q: "建築板金工事（けんちくばんきんこうじ）の意味は何ですか？", hint: "Pekerjaan pelat logam arsitektur?", opts: ["Pekerjaan pelat logam arsitektur", "Pekerjaan pelat logam industri", "Pekerjaan pelat logam ringan"], opts_id: ["Sheet metal work arsitektur ✓", "Industrial sheet metal", "Light sheet metal"], ans: 0, exp: "建築板金工事 = pekerjaan pelat logam untuk arsitektur (atap, ducting, dll)." },
    { id: 17, q: "板金の加工（ばんきんのかこう）の意味は何ですか？", hint: "Pengolahan pelat logam?", opts: ["Pengolahan pelat logam", "Pemotongan pelat logam", "Pengecatan pelat logam"], opts_id: ["Pengolahan sheet metal ✓", "Pemotongan saja", "Pengecatan"], ans: 0, exp: "板金の加工 = pengolahan pelat logam (potong, tekuk, bentuk)." },
    { id: 18, q: "ケガキの意味は何ですか？", hint: "Membuat garis penanda pada logam?", opts: ["Kegaki (membuat garis penanda)", "Mengikis", "Mengukir"], opts_id: ["Marking layout lines ✓", "Mengikis", "Mengukir"], ans: 0, exp: "ケガキ = teknik menggaris pada logam untuk panduan potong/tekuk." },
    ...
    { id: 20, q: "ダクト接続方法（ダクトのせつぞくほうほう）の意味は何ですか？", hint: "Metode sambungan saluran?", opts: ["Metode sambungan saluran", "Metode sambungan pipa", "Metode sambungan kabel"], opts_id: ["Metode sambungan duct ✓", "Sambungan pipa", "Sambungan kabel"], ans: 0, exp: "ダクト接続方法 = metode penyambungan saluran udara (ducting)." },
    { id: 21, q: "角ダクトの接続（かくダクトのせつぞく）の意味は何ですか？", hint: "Sambungan saluran bersudut?", opts: ["Sambungan saluran bersudut", "Sambungan saluran bulat", "Sambungan saluran lurus"], opts_id: ["Sambungan duct kotak ✓", "Sambungan duct bulat", "Sambungan duct lurus"], ans: 0, exp: "角ダクトの接続 = sambungan duct/saluran berbentuk kotak (rectangular)." },
    { id: 22, q: "パッキンの意味は何ですか？", hint: "Packing?", opts: ["Packing", "Penutup", "Konektor"], opts_id: ["Packing / gasket ✓", "Penutup", "Konektor"], ans: 0, exp: "パッキン = packing / gasket untuk segel anti-bocor." },
    { id: 23, q: "アングルフランジの意味は何ですか？", hint: "Flensa bersudut?", opts: ["Flensa bersudut", "Flensa pelat", "Flensa geser"], opts_id: ["Angle flange ✓", "Plate flange", "Sliding flange"], ans: 0, exp: "アングルフランジ = flensa dari besi siku untuk sambungan duct." },
    { id: 24, q: "ボルトの意味は何ですか？", hint: "Baut?", opts: ["Baut", "Paku", "Mur"], opts_id: ["Baut / bolt ✓", "Paku", "Mur"], ans: 0, exp: "ボルト = baut / bolt." },
  ...
  // ── wg9: ライフライン 6 (2) 50qs (vocab: 配管・溶接・電気・管路) ──
  {
    ...
    { id: 6, q: "施工管理（せこうかんり）のインドネシア語の意味は？", hint: "Construction management?", opts: ["Manajemen pelaksanaan konstruksi", "Manajemen kualitas", "Proses konstruksi"], opts_id: ["Manajemen pelaksanaan konstruksi ✓", "Manajemen kualitas", "Proses konstruksi"], ans: 0, exp: "施工管理 = manajemen pelaksanaan konstruksi." },
    { id: 7, q: "配管の保温保冷（はいかんのほおんほれい）の意味は？", hint: "Insulasi pipa?", opts: ["Pemasangan pipa", "Menjaga panas dan dingin untuk pemipaan", "Pemotongan pipa"], opts_id: ["Pemasangan pipa", "Menjaga panas & dingin pemipaan ✓", "Pemotongan pipa"], ans: 1, exp: "配管の保温保冷 = menjaga suhu panas dan dingin pada sistem pipa." },
    { id: 8, q: "屋内露出部分（おくないろしゅつぶぶん）の意味は？", hint: "Indoor exposed section?", opts: ["Bagian terbuka di dalam ruangan", "Bagian terbuka di luar ruangan", "Ruangan mesin"], opts_id: ["Bagian terbuka di dalam ruangan ✓", "Bagian terbuka di luar ruangan", "Ruangan mesin"], ans: 0, exp: "屋内露出部分 = bagian terbuka/terekspos di dalam ruangan." },
    { id: 9, q: "ゴム輪（ゴムわ）の意味は？", hint: "Rubber ring?", opts: ["Karet ban", "Cincin karet", "Pipa karet"], opts_id: ["Karet ban", "Cincin karet ✓", "Pipa karet"], ans: 1, exp: "ゴム輪 = cincin karet / rubber ring untuk seal sambungan pipa." },
    { id: 10, q: "検査（けんさ）の意味は？", hint: "Inspection?", opts: ["Pengujian", "Inspeksi", "Perawatan"], opts_id: ["Pengujian", "Inspeksi ✓", "Perawatan"], ans: 1, exp: "検査 = inspeksi / pemeriksaan." },
    ...
    { id: 16, q: "滑剤の塗布（かつざいのとふ）の意味は？", hint: "Lubricant application?", opts: ["Pengolesan pelumas", "Pembersihan pipa", "Pemasangan pipa"], opts_id: ["Pengolesan pelumas ✓", "Pembersihan pipa", "Pemasangan pipa"], ans: 0, exp: "滑剤の塗布 = pengolesan pelumas pada sambungan pipa." },
    { id: 17, q: "融着準備（ゆうちゃくじゅんび）の意味は？", hint: "Fusion preparation?", opts: ["Persiapan fusi", "Pemotongan pipa", "Penyambungan pipa"], opts_id: ["Persiapan fusi ✓", "Pemotongan pipa", "Penyambungan pipa"], ans: 0, exp: "融着準備 = persiapan fusi (mempersiapkan permukaan sebelum penyambungan fusi)." },
    { id: 18, q: "電気通信工事（でんきつうしんこうじ）の意味は？", hint: "Telecom work?", opts: ["Pekerjaan telekomunikasi", "Pekerjaan listrik", "Pekerjaan pendingin"], opts_id: ["Pekerjaan telekomunikasi ✓", "Pekerjaan listrik", "Pekerjaan pendingin"], ans: 0, exp: "電気通信工事 = pekerjaan telekomunikasi." },
    { id: 19, q: "高圧・低圧（こうあつ・ていあつ）の意味は？", hint: "High/low voltage?", opts: ["Tegangan tinggi dan rendah", "Pemotongan pipa", "Pemasangan kabel"], opts_id: ["Tegangan tinggi & rendah ✓", "Pemotongan pipa", "Pemasangan kabel"], ans: 0, exp: "高圧・低圧 = tegangan tinggi & rendah." },
    { id: 20, q: "消防設備工事（しょうぼうせつびこうじ）の意味は？", hint: "Fire equipment work?", opts: ["Pekerjaan peralatan pemadam kebakaran", "Pekerjaan konstruksi baja", "Pekerjaan pelat logam"], opts_id: ["Pekerjaan peralatan pemadam kebakaran ✓", "Pekerjaan konstruksi baja", "Pekerjaan pelat logam"], ans: 0, exp: "消防設備工事 = pekerjaan peralatan pemadam kebakaran." },
    ...
    { id: 25, q: "マンホール（マンホール）の意味は？", hint: "Manhole?", opts: ["Manhole", "Gudang", "Terowongan"], opts_id: ["Manhole ✓", "Gudang", "Terowongan"], ans: 0, exp: "マンホール = manhole / lubang inspeksi bawah tanah." },
    { id: 26, q: "溶接（ようせつ）の意味は？", hint: "Welding?", opts: ["Pengelasan", "Pengeboran", "Pemasangan pipa"], opts_id: ["Pengelasan ✓", "Pengeboran", "Pemasangan pipa"], ans: 0, exp: "溶接 = pengelasan / welding." },
    { id: 27, q: "電柱（でんちゅう）の意味は？", hint: "Utility pole?", opts: ["Tiang listrik", "Kabel listrik", "Konstruksi baja"], opts_id: ["Tiang listrik ✓", "Kabel listrik", "Konstruksi baja"], ans: 0, exp: "電柱 = tiang listrik / utility pole." },
    { id: 28, q: "光ファイバーケーブル（ひかファイバーケーブル）の意味は？", hint: "Fiber optic cable?", opts: ["Kabel serat optik", "Kabel listrik", "Kabel logam"], opts_id: ["Kabel serat optik ✓", "Kabel listrik", "Kabel logam"], ans: 0, exp: "光ファイバーケーブル = kabel serat optik." },
    { id: 29, q: "短絡（たんらく）の意味は？", hint: "Short circuit?", opts: ["Korsleting", "Kebocoran listrik", "Pemutusan kabel"], opts_id: ["Korsleting ✓", "Kebocoran listrik", "Pemutusan kabel"], ans: 0, exp: "短絡 = korsleting / short circuit." },
    ...
    { id: 35, q: "倉庫（そうこ）の意味は？", hint: "Warehouse?", opts: ["Gudang", "Garasi", "Ruang mesin"], opts_id: ["Gudang ✓", "Garasi", "Ruang mesin"], ans: 0, exp: "倉庫 = gudang." },
    { id: 36, q: "屋外露出部分（おくがいろしゅつぶぶん）の意味は？", hint: "Outdoor exposed section?", opts: ["Bagian terbuka di luar ruangan", "Bagian terbuka di dalam ruangan", "Ruang mesin"], opts_id: ["Bagian terbuka di luar ruangan ✓", "Bagian terbuka di dalam ruangan", "Ruang mesin"], ans: 0, exp: "屋外露出部分 = bagian terbuka/terekspos di luar ruangan." },
    ...
    { id: 42, q: "施工計画（せこうけいかく）の意味は？", hint: "Construction plan?", opts: ["Pelaksanaan konstruksi", "Rencana pelaksanaan konstruksi", "Proses konstruksi"], opts_id: ["Pelaksanaan konstruksi", "Rencana pelaksanaan konstruksi ✓", "Proses konstruksi"], ans: 1, exp: "施工計画 = rencana pelaksanaan konstruksi / construction plan." },
    { id: 43, q: "GX形ダグタイル鋳鉄管（GXがたダグタイルちゅうてつかん）の意味は？", hint: "GX-type ductile pipe?", opts: ["Pipa besi cor ulet jenis GX", "Pipa besi cor ulet suplai air", "Pipa baja karbon"], opts_id: ["Pipa besi cor ulet jenis GX ✓", "Pipa ductile suplai air", "Pipa baja karbon"], ans: 0, exp: "GX形ダグタイル鋳鉄管 = pipa besi cor ulet tipe GX (耐震性に優れる)." },
    { id: 44, q: "融着面の清掃（ゆうちゃくめんのせいそう）の意味は？", hint: "Cleaning fusion surface?", opts: ["Membersihkan permukaan fusi", "Membersihkan pipa", "Menghaluskan pipa"], opts_id: ["Membersihkan permukaan fusi ✓", "Membersihkan pipa", "Menghaluskan pipa"], ans: 0, exp: "融着面の清掃 = membersihkan permukaan yang akan difusi." },
    { id: 45, q: "電熱線（でんねつせん）の意味は？", hint: "Heating wire?", opts: ["Kawat pemanas", "Kabel listrik", "Kabel baja"], opts_id: ["Kawat pemanas ✓", "Kabel listrik", "Kabel baja"], ans: 0, exp: "電熱線 = kawat pemanas listrik." },
    { id: 46, q: "手順（てじゅん）の意味は？", hint: "Procedure?", opts: ["Prosedur kerja", "Perencanaan proyek", "Langkah awal"], opts_id: ["Prosedur kerja ✓", "Perencanaan proyek", "Langkah awal"], ans: 0, exp: "手順 = prosedur kerja / work procedure." },
  ...
  // ── wg11: ライフライン言葉第5章 50qs (vocab: 電気・配管 設備用語) ──
  {
    ...
    { id: 6, q: "テープ巻きの意味は？", hint: "Tape winding?", opts: ["Gulung kabel", "Gulung isolasi", "Gulungan pipa"], opts_id: ["Gulung kabel", "Gulung isolasi ✓", "Gulungan pipa"], ans: 1, exp: "テープ巻き = gulungan isolasi / tape winding." },
    { id: 7, q: "回路（かいろ）の意味は？", hint: "Circuit?", opts: ["Jalur listrik", "Sirkuit", "Arus pendek"], opts_id: ["Jalur listrik", "Sirkuit ✓", "Arus pendek"], ans: 1, exp: "回路 = sirkuit / circuit." },
    { id: 8, q: "圧着端子（あっちゃくたんし）の意味は？", hint: "Crimp terminal?", opts: ["Terminal pres", "Sekrup", "Konektor"], opts_id: ["Terminal pres ✓", "Sekrup", "Konektor"], ans: 0, exp: "圧着端子 = terminal pres / crimp terminal." },
    { id: 9, q: "電線管（でんせんかん）の意味は？", hint: "Conduit?", opts: ["Pipa kabel", "Selang air", "Pipa baja"], opts_id: ["Pipa kabel / konduit ✓", "Selang air", "Pipa baja"], ans: 0, exp: "電線管 = pipa kabel / conduit." },
    { id: 10, q: "配電盤（はいでんばん）の意味は？", hint: "Distribution panel?", opts: ["Saklar", "Panel distribusi", "Kabel utama"], opts_id: ["Saklar", "Panel distribusi ✓", "Kabel utama"], ans: 1, exp: "配電盤 = panel distribusi listrik." },
    ...
    { id: 14, q: "Apa bahasa Jepangnya \"Kabel pelindung logam\"?", hint: "VVR?", opts: ["CVケーブル", "VVRケーブル", "金属可とう電線管（きんぞくかとうでんせんかん）"], opts_id: ["Kabel CV", "Kabel VVR ✓", "Konduit logam fleksibel"], ans: 1, exp: "VVRケーブル = kabel pelindung logam / vinyl sheathed round cable." },
    ...
    { id: 16, q: "スリーブの意味は？", hint: "Sleeve?", opts: ["Selongsong", "Pipa baja", "Flensa"], opts_id: ["Selongsong / sleeve ✓", "Pipa baja", "Flensa"], ans: 0, exp: "スリーブ = selongsong / sleeve (pelindung lubang tembus di dinding/lantai)." },
    { id: 17, q: "モップの意味は？", hint: "Mop?", opts: ["Sapu", "Mop", "Sikat"], opts_id: ["Sapu", "Mop / pel ✓", "Sikat"], ans: 1, exp: "モップ = mop / alat pel." },
    { id: 18, q: "接着剤（せっちゃくざい）の意味は？", hint: "Adhesive?", opts: ["Perekat", "Pelapis", "Kawat"], opts_id: ["Perekat / lem ✓", "Pelapis", "Kawat"], ans: 0, exp: "接着剤 = perekat / lem / adhesive." },
    { id: 19, q: "ダクタイル鋳鉄管（ダクタイルちゅうてつかん）の意味は？", hint: "Ductile iron pipe?", opts: ["Pipa besi tuang daktail", "Pipa plastik", "Pipa PVC"], opts_id: ["Pipa besi tuang daktail ✓", "Pipa plastik", "Pipa PVC"], ans: 0, exp: "ダクタイル鋳鉄管 = pipa besi tuang daktail / ductile cast iron pipe." },
    { id: 20, q: "たらいの意味は？", hint: "Basin?", opts: ["Ember", "Baskom", "Gayung"], opts_id: ["Ember", "Baskom ✓", "Gayung"], ans: 1, exp: "たらい = baskom / basin." },
    ...
    { id: 26, q: "通気管（つうきかん）の意味は？", hint: "Vent pipe?", opts: ["Pipa udara", "Pipa pembuangan", "Pipa air bersih"], opts_id: ["Pipa udara / ventilasi ✓", "Pipa pembuangan", "Pipa air bersih"], ans: 0, exp: "通気管 = pipa udara / vent pipe." },
    { id: 27, q: "ポリブテン管の意味は？", hint: "Polybutene pipe?", opts: ["Pipa baja", "Pipa polibuten", "Pipa tembaga"], opts_id: ["Pipa baja", "Pipa polibuten ✓", "Pipa tembaga"], ans: 1, exp: "ポリブテン管 = pipa polibuten / polybutene pipe (fleksibel, tahan korosi)." },
    { id: 28, q: "防火区画（ぼうかくかく）の意味は？", hint: "Fire compartment?", opts: ["Pemisah kebakaran", "Dinding tahan gempa", "Rangka plafon"], opts_id: ["Pemisah kebakaran ✓", "Dinding tahan gempa", "Rangka plafon"], ans: 0, exp: "防火区画 = pemisah kebakaran / fire compartment." },
    { id: 29, q: "支線（しせん）の意味は？", hint: "Branch line?", opts: ["Jalur utama", "Jalur percabangan", "Jalur darurat"], opts_id: ["Jalur utama", "Jalur percabangan ✓", "Jalur darurat"], ans: 1, exp: "支線 = jalur percabangan / branch line." },
    { id: 30, q: "電工ドラム（でんこうドラム）の意味は？", hint: "Cable drum?", opts: ["Drum kabel listrik", "Drum air", "Tangki minyak"], opts_id: ["Drum kabel listrik ✓", "Drum air", "Tangki minyak"], ans: 0, exp: "電工ドラム = drum kabel listrik / cable reel." },
    ...
    { id: 36, q: "作業灯（さぎょうとう）の意味は？", hint: "Work light?", opts: ["Lampu kerja", "Lampu darurat", "Lampu lalu lintas"], opts_id: ["Lampu kerja ✓", "Lampu darurat", "Lampu lalu lintas"], ans: 0, exp: "作業灯 = lampu kerja / work light." },
    { id: 37, q: "鉛管（なまりかん）の意味は？", hint: "Lead pipe?", opts: ["Pipa timah", "Pipa besi", "Pipa tembaga"], opts_id: ["Pipa timah ✓", "Pipa besi", "Pipa tembaga"], ans: 0, exp: "鉛管 = pipa timah / lead pipe." },
    { id: 38, q: "逆止弁（ぎゃくしべん）の意味は？", hint: "Check valve?", opts: ["Katup buka-tutup", "Katup balik", "Katup kontrol"], opts_id: ["Katup buka-tutup", "Katup balik / check valve ✓", "Katup kontrol"], ans: 1, exp: "逆止弁 = katup balik / check valve (mencegah aliran balik)." },
    { id: 39, q: "コンクリートミキサの意味は？", hint: "Concrete mixer?", opts: ["Pengaduk semen", "Pengaduk pasir", "Pengaduk beton"], opts_id: ["Pengaduk semen", "Pengaduk pasir", "Pengaduk beton ✓"], ans: 2, exp: "コンクリートミキサ = pengaduk beton / concrete mixer." },
    { id: 40, q: "絶縁テープ（ぜつえんテープ）の意味は？", hint: "Insulation tape?", opts: ["Pita perekat", "Pita pelindung", "Isolasi listrik"], opts_id: ["Pita perekat", "Pita pelindung", "Isolasi listrik ✓"], ans: 2, exp: "絶縁テープ = selotip isolasi listrik / electrical insulation tape." },
    ...
    { id: 43, q: "Apa bahasa Jepangnya \"Kunci pipa kecil\"?", hint: "パイプレンチ?", opts: ["モーターレンチ", "パイプレンチ", "プライヤー"], opts_id: ["Motor wrench", "Pipe wrench ✓", "Plier"], ans: 1, exp: "パイプレンチ = kunci pipa / pipe wrench." },
    ...
    { id: 46, q: "フレキシブル管の意味は？", hint: "Flexible pipe?", opts: ["Pipa fleksibel", "Pipa keras", "Selang air"], opts_id: ["Pipa fleksibel ✓", "Pipa keras", "Selang air"], ans: 0, exp: "フレキシブル管 = pipa fleksibel / flexible conduit." },
    { id: 47, q: "給水タンク（きゅうすいたんく）の意味は？", hint: "Water tank?", opts: ["Tangki pembuangan", "Tangki air bersih", "Tangki minyak"], opts_id: ["Tangki pembuangan", "Tangki air bersih ✓", "Tangki minyak"], ans: 1, exp: "給水タンク = tangki air bersih / water supply tank." },
    { id: 48, q: "吸気ファン（きゅうきファン）の意味は？", hint: "Intake fan?", opts: ["Exhaust fan", "Kipas buang", "Kipas isap"], opts_id: ["Exhaust fan", "Kipas buang", "Kipas isap ✓"], ans: 2, exp: "吸気ファン = kipas isap / intake fan (menghisap udara masuk)." },
    { id: 49, q: "ワイヤーストリッパーの意味は？", hint: "Wire stripper?", opts: ["Tang potong", "Pengupas kabel", "Obeng"], opts_id: ["Tang potong", "Pengupas kabel ✓", "Obeng"], ans: 1, exp: "ワイヤーストリッパー = pengupas kabel / wire stripper." },
    { id: 50, q: "水平器（すいへいき）の意味は？", hint: "Spirit level?", opts: ["Waterpass", "Pengukur jarak", "Leveling laser"], opts_id: ["Waterpass / spirit level ✓", "Pengukur jarak", "Leveling laser"], ans: 0, exp: "水平器 = waterpass / spirit level." }
    ]
  }
];
        ...
        {opts.map((opt, idx) => {
          ...
          return (
            <button key={idx} onClick={() => handleAngkaSelect(idx)} style={{ fontFamily: "inherit", padding: "13px 16px", fontSize: 14, borderRadius: 14, background: bg, border, color, cursor: selected !== null ? "default" : "pointer", textAlign: "left", lineHeight: 1.4, fontWeight: 600, display: "flex", gap: 10, alignItems: "center" }}>
              <span style={{ width: 26, height: 26, borderRadius: 7, flexShrink: 0, background: "rgba(255,255,255,0.06)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 700, border: "1px solid rgba(255,255,255,0.15)" }}>
                {selected !== null ? (opt.correct ? "✓" : idx === selected ? "✗" : idx + 1) : idx + 1}
              </span>
  ...
  return (
    <div style={{ padding: "0 16px 24px", maxWidth: 560, margin: "0 auto" }}>
      ...
      <div
        ...
        <div style={{ fontSize: 11, opacity: 0.6, letterSpacing: 2, marginBottom: 10 }}>{info.emoji} {info.label} · #{card.id}</div>
        <JpFront text={card.jp} />
...
function SumberMode() {
  ...
  if (activeSrc && card) {
    ...
    return (
      <div style={{ padding: "0 16px 24px", maxWidth: 560, margin: "0 auto" }}>
        {/* header */}
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12, background: "rgba(255,255,255,0.06)", borderRadius: 14, padding: "10px 14px", border: `1px solid ${accent}25` }}>
          <button onClick={() => { setActiveSrc(null); setSrcIdx(0); setFlipped(false); }}
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: 11, color: "#64748b", marginTop: 1 }}>Kartu {srcIdx + 1} dari {srcCards.length}</div>
          </div>
        </div>
        ...
        <div onClick={() => setFlipped(f => !f)} style={{
          ...
          {!flipped ? (
            <div style={{ textAlign: "center", width: "100%" }}>
              ...
              <div style={{ fontSize: 11, color: "#475569", marginTop: 14, display: "flex", alignItems: "center", justifyContent: "center", gap: 5 }}>
                <span style={{ color: accent, opacity: 0.6 }}>↕</span> tap untuk lihat arti
              </div>
            </div>
          ) : (
            <div style={{ textAlign: "center", width: "100%" }}>
...
function WaygroundQuizMode({ set, onBack }) {
  ...
  const q = qs[qIdx];
  const displayQ   = showFuri ? q.q : stripFuri(q.q);
  const displayOpt = (o) => showFuri ? o : stripFuri(o);
  ...
  const restart = () => {
    ...
    setStreak(0); setMaxStreak(0); setShowHint(false);
  };
  ...
  return (
    <div style={{ padding: "0 16px", maxWidth: 560, margin: "0 auto" }}>
      {/* header strip */}
      <div style={{ background: "rgba(29,78,216,0.15)", border: "1px solid rgba(96,165,250,0.2)", borderRadius: 16, padding: "12px 14px", marginBottom: 14 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
          <div>
          ...
          <button onClick={onBack} style={{ fontFamily: "inherit", padding: "6px 12px", borderRadius: 10, fontSize: 11, fontWeight: 600, background: "rgba(0,0,0,0.3)", border: "1px solid rgba(255,255,255,0.1)", color: "#94a3b8", cursor: "pointer" }}>✕</button>
        </div>
        {/* toggle row */}
        <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
          <button onClick={() => setShowFuri(f => !f)} style={{ fontFamily: "inherit",
            padding: "5px 10px", borderRadius: 8, fontSize: 10, fontWeight: 700, cursor: "pointer",
            border: `1px solid ${showFuri ? "rgba(147,197,253,0.4)" : "rgba(255,255,255,0.08)"}`,
            background: showFuri ? "rgba(147,197,253,0.15)" : "rgba(0,0,0,0.2)", color: showFuri ? "#93c5fd" : "#64748b",
          }}>あ 振り仮名</button>
          <button onClick={() => setShowID(f => !f)} style={{ fontFamily: "inherit",
            padding: "5px 10px", borderRadius: 8, fontSize: 10, fontWeight: 700, cursor: "pointer",
            border: `1px solid ${showID ? "rgba(251,191,36,0.4)" : "rgba(255,255,255,0.08)"}`,
            background: showID ? "rgba(251,191,36,0.12)" : "rgba(0,0,0,0.2)", color: showID ? "#fbbf24" : "#64748b",
          }}>🇮🇩 Terjemahan</button>
          <button onClick={() => setShowHint(h => !h)} style={{ fontFamily: "inherit",
            padding: "5px 10px", borderRadius: 8, fontSize: 10, fontWeight: 700, cursor: "pointer",
            border: `1px solid ${showHint ? "rgba(251,191,36,0.4)" : "rgba(255,255,255,0.08)"}`,
            background: showHint ? "rgba(251,191,36,0.12)" : "rgba(0,0,0,0.2)", color: showHint ? "#fbbf24" : "#64748b",
          }}>💡 Hint</button>
        </div>
      </div>
      ...
      <div style={{ borderRadius: 20, background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", padding: "20px 18px", marginBottom: 14 }}>
        <div style={{ fontSize: 15, color: "#e2e8f0", lineHeight: 1.9, fontFamily: "'Zen Kaku Gothic New','Noto Sans JP',sans-serif" }}>{displayQ}</div>
        {showHint && (
          <div style={{ fontSize: 13, color: "#94a3b8", fontStyle: "italic", borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: 10, marginTop: 12, lineHeight: 1.6 }}>
            🇮🇩 {q.hint}
          </div>
        )}
      </div>
        ...
        {q.opts.map((opt, i) => {
          ...
          return (
            <button key={i} onClick={() => pick(i)} style={{ fontFamily: "inherit",
              ...
              <span style={{ width: 28, height: 28, borderRadius: 8, background: "rgba(0,0,0,0.2)", border: `1px solid ${border}`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 700, flexShrink: 0, color: icon ? (i === q.ans ? "#4ade80" : "#f87171") : "#64748b" }}>
                {icon || (i + 1)}
              </span>
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontFamily: "'Zen Kaku Gothic New','Noto Sans JP',sans-serif" }}>{displayOpt(opt)}</div>
                {/* Show Indonesian ONLY when toggle is ON or AFTER answering */}
                {(showID || selected !== null) && (
                  <div style={{ fontSize: 11, color: selected !== null ? (i === q.ans ? "#86efac" : "#94a3b8") : "#94a3b8", marginTop: 3, opacity: 0.8 }}>{q.opts_id[i]}</div>
                )}
              </div>
            </button>
          );
      ...
      {showExp && (
        <div style={{ borderRadius: 14, background: isCorrect ? "rgba(34,197,94,0.08)" : "rgba(239,68,68,0.08)", border: `1px solid ${isCorrect ? "rgba(34,197,94,0.25)" : "rgba(239,68,68,0.25)"}`, padding: "14px 16px", marginBottom: 14, lineHeight: 1.8 }}>
          <div style={{ fontSize: 12, color: isCorrect ? "#4ade80" : "#f87171", fontWeight: 700, marginBottom: 6 }}>
            {isCorrect ? "✓ Benar!" : `✗ Salah — Jawaban: ${q.ans + 1}) ${displayOpt(q.opts[q.ans])}`}
          </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 18 }}>
        {answers.map((a, i) => (
          <div key={i} style={{ padding: "12px 14px", borderRadius: 13, background: a.correct ? "rgba(34,197,94,0.06)" : "rgba(239,68,68,0.06)", border: `1px solid ${a.correct ? "rgba(34,197,94,0.2)" : "rgba(239,68,68,0.2)"}` }}>
            ...
            <div style={{ fontSize: 11, color: "#3d5070", fontStyle: "italic", lineHeight: 1.6, marginBottom: 5 }}>🇮🇩 {a.q.hint}</div>
...
export default function FlashcardApp() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)", fontFamily: "'Noto Sans JP', 'Segoe UI', sans-serif", color: "#e2e8f0", userSelect: "none" }}>
      ...
      <div style={{ padding: "14px 16px 2px", display: "flex", alignItems: "flex-start", justifyContent: "center", position: "relative" }}>
        <div style={{ textAlign: "center", flex: 1, minWidth: 0 }}>
          ...
          <div style={{ fontSize: 11, color: "#64748b", marginTop: 3 }}>
            {CARDS.length} kartu · {JAC_OFFICIAL.length} soal JAC · {WAYGROUND_SETS.length} set Wayground · v68
          </div>
